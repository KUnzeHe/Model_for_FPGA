...
from model_for3modes import for3modes_net  # 导入自定义的神经网络模型
...
def model_train(network_class, out_dict_dir: str = "model_pth", batch_size: int = 128,
    ...
    # 准备数据集
    if out_dict_dir == "model_pth/3modes":
        # 3模态数据集
        train_data = LPModesDataset('Model_for_MD/datasets/3modes_mode_decomposition_dataset_train_regression.npz')
        test_data = LPModesDataset('Model_for_MD/datasets/3modes_mode_decomposition_dataset_test_regression.npz')
    elif out_dict_dir == "model_pth/5modes":
        # 5模态数据集
        train_data = LPModesDataset('Model_for_MD/datasets/5modes_mode_decomposition_dataset_train_regression.npz')
        test_data = LPModesDataset('Model_for_MD/datasets/5modes_mode_decomposition_dataset_test_regression.npz')
    elif out_dict_dir == "model_pth/6modes":
        # 6模态数据集
        train_data = LPModesDataset('Model_for_MD/datasets/6modes_mode_decomposition_dataset_train_regression.npz')
        test_data = LPModesDataset('Model_for_MD/datasets/6modes_mode_decomposition_dataset_test_regression.npz')
